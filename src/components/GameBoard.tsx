...
export default function GameBoard({
  ...
  const getTerritoryClass = (q: number, r: number): string => {
    ...
    if (playerPosition.x === q && playerPosition.y === r)
        ...
        {board.territories.map((territory, idx) => {
          ...
          return (
            ...
            >
              <div
                className="hexagon"
                style={{ backgroundColor: getTerritoryColor(territory.type) }}
              >
                <div className="hex-content">
                  ...
                  {playerPosition.x === territory.x &&
                    playerPosition.y === territory.y && (
                      <div className="unit-marker player-marker">👤</div>
                    )}
                  {aiPosition.x === territory.x &&
                    aiPosition.y === territory.y && (
